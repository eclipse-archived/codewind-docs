...
keywords: install, run, open, import, show, restart, edit, build, logs, tools, eclipse, Eclipse Codewind tool for OpenAPI
duration: 1 minute
...
## Installing
1. Download and install the latest [Eclipse IDE for Java EE Developers](https://www.eclipse.org/downloads/packages/release/) or use an existing installation. If you use the Eclipse Codewind tool for OpenAPI, the earliest supported version of the Eclipse IDE for Codewind is Version 2019-06 (4.12).
2. [Optional] Install [Codewind from the Eclipse Marketplace](https://marketplace.eclipse.org/content/codewind).
3. Install the [Eclipse Codewind tool for OpenAPI from the Eclipse Marketplace](https://marketplace.eclipse.org/content/codewind).
