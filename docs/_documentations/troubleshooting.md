...
6. You see all of your default template projects up and running but Appsody projects are stuck in `Starting` or `Stopped` state even though the container logs says the projects are up and running. 
